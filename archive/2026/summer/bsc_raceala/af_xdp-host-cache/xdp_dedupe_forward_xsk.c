...
// the program that gets attached to the two
// physical interfaces in the AF_XDP setup
...
int xdp_dedupe_forward(struct xdp_md *ctx) {
    ...
    // setting the valid bit regardless
    // of what was there beforehand
    ...
    // redirect to the AF_XDP host-cache
